...
OFT's rotation kernel needs bf16 tl.dot operands, so peft/oft/moe_invoke.py's
...
touches ``moe_invoke.py`` or the fp8 branch):
...
from sglang.srt.peft.oft.triton_ops.parity_dequant_fp8 import dequant_fp8_block_triton
