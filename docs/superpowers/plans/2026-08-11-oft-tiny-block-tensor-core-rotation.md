...
from sglang.srt.peft.oft.triton_ops.gemm_oft_r import gemm_oft_r_fwd
```
...
**Files:**
- Modify: `python/sglang/srt/peft/oft/triton_ops/fused_rotate_project.py:318-470`
...
```bash
python -m compileall -q python/sglang/srt/peft/oft/triton_ops/fused_rotate_project.py
git diff --check
```
...
**Files:**
- Modify: `python/sglang/srt/peft/oft/triton_ops/fused_rotate_project.py` only if the accepted virtual-16 implementation needs a measured correction.
...
```bash
git add python/sglang/srt/peft/oft/triton_ops/fused_rotate_project.py \
