...
Everything here is a verbatim relocation of that logic; ``model_runner.py``
now only imports this module as ``peft`` and makes thin guarded call-outs
(``peft.maybe_init_peft_manager(self, server_args)``, etc.) so upstream rebases
stay cheap.
"""
