...
class OFTConfig:
    def __init__(
        ...
        if config_dict is not None:
            ...
            self.hf_config = self.get_oft_config()
        ...
        self.coft = self.hf_config.get("coft", False)
    ...
    def get_oft_config(self, dummy=False):
        if dummy:
    ...
    def get_added_tokens_config(self):
        """Load added tokens from the OFT adapter if the file exists."""
        ...
        # Return None if the file doesn't exist (optional for standard OFT adapters)
